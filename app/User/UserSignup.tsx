...
import authService from '../../appwriteconfig'; // ✅ Adjust the path as per your project structure
...
const UserSignup = () => {
  ...
  return (
    <View className="flex-1 justify-center items-center bg-white px-6">
      <Text className="text-3xl font-bold text-blue-600 mb-8">User Signup</Text>
